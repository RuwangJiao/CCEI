function logtheta_all = learn_mtgp( logtheta_all, deriv_range, data )
    ...
    [logtheta, nl] = minimize(logtheta0,'nmargl_mtgp',niter, logtheta_all, covfunc_x, xtrain, ytrain, M, irank, nx, ind_kf_train, ind_kx_train, deriv_range);
